...
// currentActiveChannel_(nullptr)
{
    ...
    //每一个eventloop都将监听wakeupchannel的REPOLLIN读事件了
...
void EventLoop::queueInLoop(Functor cb)
{
    ...
    //  ||callingPendingFuncors_的意思是 当前loop正在执行回调，但是loop又有了新的回调
    ...
    void EventLoop::doPendignFunctors() //执行回调
    {
